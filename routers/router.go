...
func init() {
	...
	beego.Router("/liuyan", &controllers.UserController{}, "POST:LiuYan")
	...
	beego.Router("/user/msgpage", &controllers.UserController{}, "GET:MessagePage")  //消息页面
	...
	beego.Router("/topic/dashang", &controllers.TopicController{}, "POST:DaShang") //演示
